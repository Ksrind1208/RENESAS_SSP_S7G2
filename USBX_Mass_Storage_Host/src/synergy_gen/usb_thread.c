...
static uint8_t usb_thread_stack[4096] BSP_PLACE_IN_SECTION_V2(".stack.usb_thread") BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
...
void usb_thread_create(void)
{
    ...
    UINT err;
    err = tx_thread_create (&usb_thread, (CHAR*) "USB Thread", usb_thread_func, (ULONG) NULL, &usb_thread_stack, 4096,
